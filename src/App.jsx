...
function useTilt() {
  ...
  const onMouseMove = (e) => {
    ...
    // Coalesce rapid mousemove events into a single state update per animation
    // frame instead of one setState per pixel of movement — this is what was
    // causing visible lag when hovering across the job cards.
...
export default function App() {
  ...
  }, [currentUser, session, requestAuth, showToast]);
...
//   const requestAuth = () => { setAuthError(''); setAuthModalOpen(true); };
